...
<div class="col-lg-6"><span >UNCOMPRESSED IMAGE :</span>
    <div class="fileupload fileupload-new" data-provides="fileupload">
                      <div class="fileupload-new thumbnail col-md-6">
                        <img src="images/<?php echo $fg['oimg']?>" alt="" />
                      </div>
                  ...
                  <span >IMAGE SIZE : <?php echo filesize('images/'.$fg['oimg']).'Bytes';?></span><br>
 ...
 <span >IMAGE SIZE : <?php echo filesize($fg['nimg']).'Bytes';?></span><br>
  <span class="label label-info" ><a href="<?php echo $fg['nimg']?>" alt="" style="color: white;">Download compressed image</span></a> </span>
</div>
</div>
